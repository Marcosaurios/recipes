...
export interface TypeRecetaFields {
    ...
    category: EntryFieldTypes.Array<EntryFieldTypes.Symbol<"arroz" | "de cuchara" | "ensaladas" | "entrante" | "favoritos" | "postre">>;
...
export type TypeReceta<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeRecetaSkeleton, Modifiers, Locales>;
